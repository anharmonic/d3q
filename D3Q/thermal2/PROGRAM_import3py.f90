...
#include "mpi_thermal.h"
  ...
  SUBROUTINE read_3py(filefc3, fc, S)
...
PROGRAM import3py
  ...
  LOGICAL :: writed3
  !
  filefc3 = cmdline_param_char("f", "FORCE_CONSTANTS_3RD")
  filefc2 = cmdline_param_char("s", "mat2R")
  fileout_good = cmdline_param_char("o", "mat3R.3py")
  writed3  = cmdline_param_logical("w")
  print*, "cazzo", writed3
  IF(cmdline_param_logical('h'))THEN
    WRITE(*,'(a)') "d3_import3py.x [-f FORCE_CONSTANTS_3RD] [-s HEADER] [-o FILEOUT] [-w] NQX NQY NQZ"
  ...
  CLOSE(999)
  !
  !CALL scan_3py(filefc3, S)
  CALL read_3py(filefc3, fc, S)
